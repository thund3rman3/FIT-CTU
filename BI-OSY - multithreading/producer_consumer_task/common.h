...
public:
    ...
    double m_TriangMin = 0; // nejmensi pocet vyztuh pro nejvetsi pevnost
    CBigInt m_TriangCnt; // pocet ruznych moznosti jak rozdelit triangMin vyztuh
};
...
public:
    //---------------------------------------------------------------------------------------------------------------------------------------------------------
    virtual ~CProblemPack() noexcept = default;
