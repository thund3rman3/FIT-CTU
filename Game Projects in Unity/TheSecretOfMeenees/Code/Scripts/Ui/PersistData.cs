...
public class PlayerDataModifiable
{
    ...
    public List<bool> PagesOwned = new List<bool>();
}
...
public static class PersistData
{
    ...
    public static void PopulateOnNewGame()
    {
        ...
        playerData.PagesOwned.Add(true);
        playerData.PagesOwned.Add(true);
    ...
    public static void PopulateSkipTutorial()
    {
        //Here we should read from the scriptable objects...TODO
        ...
        Array.Fill(playerData.EnabledElements, true);
        playerData.PagesOwned.Add(true);
        playerData.PagesOwned.Add(true);
        playerData.PagesOwned.Add(true);
    ...
    public static void EmergeFromDungeon()
    {
        for (int i = 0; i < 4; i++)
        {
            ...
            if (dungeonData.carriedUniqueNPCs[i])
            {
        ...
        //calculate random NPC vanishes etc. TODO
        dungeonData.ClearData();
    }
